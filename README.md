...
| `getHostById` | POST | [**id**] | "http_code": "200 OK", "result": [with the executed actions] | return the given host |
...
| `deleteHostbyId` | POST | [**hostId, exportConfiguration**] | "http_code": "200 OK", "result": ["code":returnCode,"description":"logs"]  | Delete a nagios host by its ID. |
